...
## 29. Top Earners [HackerRank Question](https://www.hackerrank.com/challenges/earnings-of-employees/problem?isFullScreen=true)
...
- group by 1/group by total_earnings -- ill take simple example..consider query SELECT name , id FROM employee group by 1; in this query there are 2 columns i.e., name and id...So we have to group it by 1st column that is name.
- order by total_earnings desc -- it will order the table in desc order do that max value appears frst.
